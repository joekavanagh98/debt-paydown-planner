...
The v9 hardening pass added input bounds, rate limits, register
enumeration mitigation, and operational documentation. See
`docs/v9-hardening.md` for the threat model, audit results, secret
rotation procedure, and the explicit non-decisions.
